...
public sealed record WrittenSceneOutcomeContext
{
    ...
    /// <summary>获取已进入 Writing 路径的 Scene。</summary>
    public required ScenarioSceneView Scene { get; init; }
...
public interface IWrittenSceneOutcomeContributor
{
    ...
    ValueTask<ScenarioChangeProposal> ContributeAsync(WrittenSceneOutcomeContext context, CancellationToken cancellationToken);
}
