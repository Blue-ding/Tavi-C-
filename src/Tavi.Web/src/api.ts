...
export const worldApi = {
  ...
  addScope: (stateId: string, quantity: number, type: string, ownerElementId: string) => request(`${worldUrl}/scopes`, { method: 'POST', body: JSON.stringify({ expectedStateId: stateId, quantity, type, ownerElementId }) }),
  updateScope: (id: string, stateId: string, changes: { quantity?: number; type?: string }) => request(`${worldUrl}/scopes/${id}`, { method: 'PATCH', body: JSON.stringify({ expectedStateId: stateId, ...changes }) }),
  removeScope: (id: string, stateId: string) => request(`${worldUrl}/scopes/${id}?expectedStateId=${stateId}`, { method: 'DELETE' }),
  addAspect: (stateId: string, quantity: number, type: string, elementId: string, scopeId: string) => request(`${worldUrl}/aspects`, { method: 'POST', body: JSON.stringify({ expectedStateId: stateId, quantity, type, elementId, scopeId }) }),
  updateAspect: (id: string, stateId: string, changes: { quantity?: number; type?: string }) => request(`${worldUrl}/aspects/${id}`, { method: 'PATCH', body: JSON.stringify({ expectedStateId: stateId, ...changes }) }),
  removeAspect: (id: string, stateId: string) => request(`${worldUrl}/aspects/${id}?expectedStateId=${stateId}`, { method: 'DELETE' }),
  addRelation: (stateId: string, quantity: number, type: string, sourceElementId: string, targetElementId: string, scopeId: string) => request(`${worldUrl}/relations`, { method: 'POST', body: JSON.stringify({ expectedStateId: stateId, quantity, type, sourceElementId, targetElementId, scopeId }) }),
  updateRelation: (id: string, stateId: string, changes: { quantity?: number; type?: string }) => request(`${worldUrl}/relations/${id}`, { method: 'PATCH', body: JSON.stringify({ expectedStateId: stateId, ...changes }) }),
  removeRelation: (id: string, stateId: string) => request(`${worldUrl}/relations/${id}?expectedStateId=${stateId}`, { method: 'DELETE' }),
  addLocalAspect: (stateId: string, name: string, description: string, quantity: number, elementId: string, scopeId: string) => request(`${worldUrl}/local-aspects`, { method: 'POST', body: JSON.stringify({ expectedStateId: stateId, name, description, quantity, elementId, scopeId }) }),
  updateLocalAspect: (id: string, stateId: string, changes: { name?: string; description?: string; quantity?: number }) => request(`${worldUrl}/local-aspects/${id}`, { method: 'PATCH', body: JSON.stringify({ expectedStateId: stateId, ...changes }) }),
  removeLocalAspect: (id: string, stateId: string) => request(`${worldUrl}/local-aspects/${id}?expectedStateId=${stateId}`, { method: 'DELETE' }),
  addLocalRelation: (stateId: string, name: string, description: string, quantity: number, sourceElementId: string, targetElementId: string, scopeId: string) => request(`${worldUrl}/local-relations`, { method: 'POST', body: JSON.stringify({ expectedStateId: stateId, name, description, quantity, sourceElementId, targetElementId, scopeId }) }),
  updateLocalRelation: (id: string, stateId: string, changes: { name?: string; description?: string; quantity?: number }) => request(`${worldUrl}/local-relations/${id}`, { method: 'PATCH', body: JSON.stringify({ expectedStateId: stateId, ...changes }) }),
  removeLocalRelation: (id: string, stateId: string) => request(`${worldUrl}/local-relations/${id}?expectedStateId=${stateId}`, { method: 'DELETE' }),
